...
const testingDataCircle = processTrainingData(realCircle)
	.shapeTrainingDataPoints[0]
const testingDataSquare = processTrainingData(realSquare)
	.shapeTrainingDataPoints[0]
const testingDataTriangle = processTrainingData(realTriangle)
	.shapeTrainingDataPoints[0]
const testingDataLine = processTrainingData(realLine).shapeTrainingDataPoints[0]

const runTraining = () => {
	fetchRawStrokeData().then(
		({ shapeTrainingDataPoints, shapeCorrespondingOutputData }) => {
